...
const FORDEFI_API_USER_TOKEN =
  process.env.FORDEFI_API_USER_MACBOOK_PRO_BOT ??
  (() => {
...
const FORDEFI_EVM_VAULT_ADDRESS =
  process.env.FORDEFI_EVM_VAULT_ADDRESS ??
  (() => {
    throw new Error("FORaDEFI_EVM_VAULT_ADDRESS is not set");
  })();
